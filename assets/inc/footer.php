            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-about">
                        <img src="assets/images/icons/law-logo.png" alt="image">
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="contact-list">
                            <li>
                                ...
                                <div class="text">
                                    <a href="tel:+8801761111458" class="mb-0">+91 9876543210</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <a href="#!" class="mb-0"><span
                                            class="__cf_email__">infoexample@gmail.com</span></a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
        ...
        <div class="footer-bottom">
            <div class="row d-flex align-items-center g-3">
                <div class="col-lg-12 px-1 text-center">
                    <p>Copyright 2025 Suvanjali. All rights reserved. | Design By <a href="https://www.cssfounder.com"
                            class="egns-lab" target="_blank">CssFounder.com</a></p>
                </div>
            </div>
        </div>
    </div>
